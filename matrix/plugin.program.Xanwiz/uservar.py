...
REPOADDONXML = 'https://team-xanax.github.io/matrix/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://team-xanax.github.io/matrix/zips/repository.Xanax'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR blue][B]Xanax[/B][/COLOR]Wizard'
